...
class LoginPlaquiste extends StatelessWidget {
  const LoginPlaquiste({super.key});
  @override
          ...
          child: Form(
            ...
            child: ListView(
              children: [
                ...
                CustomTextBodyAuth(
                    text:
                        "Connectez-vous avec votre Mail ou Numéro de téléphone et votre mot de passe Ou continuez avec les réseaux sociaux"),
                SizedBox(height: 10),
                SizedBox(height: 40),
                CustomTextFormAuth(
                  isNumber: false,
                  ...
                  hintText: "Enter votre Email ou Numéro de téléphone",
