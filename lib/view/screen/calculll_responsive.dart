...
print("height ===> $height");
    ...
    double width_svg=width+440;
double width_dessin=width+81;
double height_svg=height+400;


int pas_x=(width_dessin/opo).round();
double pas_y=pas_x/2;
double height_dessein=(rep_rgb+rep_rga)*pas_y;
print("height of dessin: $height_dessein");
print("pas y : $pas_y");

 double hauter_des_plaque_sans_decoupe=nbrplaquesansdecoupe_hauteur*pas_y;
...
double position_arrow=(width_dessin/2)-75;
 ...
 <g class="layer">
  ...
  <text fill="#000000" font-family="Serif" font-size="50" id="svg_18" stroke="#ff0000" stroke-width="0" text-anchor="middle" x="$position_text" xml:space="preserve" y="19">LC= $largeur  </text>
